<?php 
    if (isset($_POST["btncalcular"])) {
        ...
        if($objSalario->calcularSalarioBruto() <= 1000000){
            ...
            echo "<b> El descuento de pension es: </b>" . $objPension->calcularPension(0.06) . "<br>";
            ...
            echo "<b> El descuento de pension es: </b>" . $objPension->calcularPension(0.07) . "<br>";
        ...
        echo "El FBI va en camino, CORRE PERRA, CORRE!!";
    }
?>